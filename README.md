...
This repository contains a customized theme for Keycloak, an open-source identity and access management solution. The
customized theme allows you to modify the look and feel of the Keycloak user interface to align with your branding and
user experience requirements.

## Development

For local development, you can use Docker Compose to quickly spin up a Keycloak instance. This allows you to test your
theme customizations without affecting your production environment.
...
2. Navigate to the `themes/nexdatum-theme` folder.
    - rename `nexdatum-theme` folder as you need for your project
    - you can create many custom themes as shown in the example (/themes/ [my-custom-theme, nexdatum-theme, ...] / ).
3. Modify the template files (e.g., HTML, CSS) and resources (e.g., images) according to your branding and design
   requirements.
...
5. Go to the "Realm Settings" > "Themes" section. Here you can select and activate your custom theme if you only need
   one theme for your project.

###### _Note_

If you want to customize several themes for different Clients, you should choose a theme by going to the "Clients tab"
in your Realm. Then select the necessary Client, in the "Settings tab" go down to the "Login settings" and there in
the "Login theme" window select the theme you need. Here you can set the "Login theme" only.
...
submitting a pull request. Your contributions are greatly appreciated.
